...
#include "../../lua/src/lua_script_system.h"
...
namespace Lumix {
	...
	void registerLuaAPI(lua_State* L) {
		...
		}
		{
			...
			lua_setfield(L, -2, "F");
			LuaWrapper::push(L, 71);
			lua_setfield(L, -2, "G");
			LuaWrapper::push(L, 72);
			lua_setfield(L, -2, "H");
			LuaWrapper::push(L, 73);
			lua_setfield(L, -2, "I");
			LuaWrapper::push(L, 74);
			lua_setfield(L, -2, "J");
			LuaWrapper::push(L, 75);
			lua_setfield(L, -2, "K");
			LuaWrapper::push(L, 76);
			lua_setfield(L, -2, "L");
			LuaWrapper::push(L, 77);
			lua_setfield(L, -2, "M");
			LuaWrapper::push(L, 78);
			lua_setfield(L, -2, "N");
			LuaWrapper::push(L, 79);
			lua_setfield(L, -2, "O");
			LuaWrapper::push(L, 80);
			lua_setfield(L, -2, "P");
			LuaWrapper::push(L, 81);
			lua_setfield(L, -2, "Q");
			LuaWrapper::push(L, 82);
			lua_setfield(L, -2, "R");
			LuaWrapper::push(L, 83);
			lua_setfield(L, -2, "S");
			LuaWrapper::push(L, 84);
			lua_setfield(L, -2, "T");
			LuaWrapper::push(L, 85);
			lua_setfield(L, -2, "U");
